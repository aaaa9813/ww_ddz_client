...
public abstract class SmartCard : MonoBehaviour
{
    ...
    public virtual IEnumerator DelayDiscardCard(bool isNone)
    {
        ...
        switch (rule)
        {
            ...
            case CardsType.JokerBoom:
                ...
                break;
            case CardsType.Boom:
                List<Card> discardCards_01 = FindBoom(GetAllCards(null), deskWeight, false);
            ...
            case CardsType.Double:
                List<Card> discardCards_02 = FindDouble(GetAllCards(null), deskWeight, false);
            ...
            case CardsType.Single:
                List<Card> discardCards_03 = FindSingle(GetAllCards(null), deskWeight, false);
            ...
            case CardsType.OnlyThree:
                List<Card> discardCards_04 = FindOnlyThree(GetAllCards(null), deskWeight, false);
            ...
            case CardsType.Straight:
                List<Card> discardCards_05 = FindStraight(GetAllCards(null), DeskCardsCache.Instance.MinWeight, DeskCardsCache.Instance.CardsCount, false);
                ...
                {
                    List<Card> boom = FindBoom(GetAllCards(null), 0, true);
                    if (boom.Count != 0)
                    {
                        RemoveCards(boom);
            ...
            case CardsType.ThreeAndOne:
                List<Card> discardCards_06 = FindThreeAndOne(GetAllCards(null), deskWeight, false);
            ...
            case CardsType.ThreeAndTwo:
                List<Card> discardCards_08 = FindThreeAndTwo(GetAllCards(null), deskWeight, false);
            ...
            case CardsType.DoubleStraight:
                List<Card> discardCards_10 = FindStraight(GetAllCards(null), DeskCardsCache.Instance.MinWeight, DeskCardsCache.Instance.CardsCount, false);
            ...
            case CardsType.TripleStraight:
                List<Card> boom_01 = FindBoom(GetAllCards(null), 0, true);
                if (boom_01.Count != 0)
                {
                    RemoveCards(boom_01);
    ...
    /// </summary>
    /// <returns></returns>
    protected List<Card> GetAllCards(List<Card> exclude)
    {
    ...
    protected void ShowNotice()
    {
       ...
       //ww computerNotice.GetComponent<TweenAlpha>().ResetToBeginning();
      //ww  computerNotice.GetComponent<TweenAlpha>().PlayForward();
      //ww  StartCoroutine(DisActiveNotice(computerNotice));
    }
